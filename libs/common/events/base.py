"""Base event classes for trading system."""
...
class BaseEvent(BaseModel, ABC):
    """Abstract base class for all events in trading system."""
    ...
    causation_id: Optional[UUID] = Field(None, description="ID of event that caused this event")

"""Trading212 broker adapter -- ROADMAP MARKER (not implemented).
...
Plan for future implementation:
    - SDK: no official API; reverse-engineered options exist
    - Asset classes: EU equities, ETFs, CFDs
    - Priority: LOWEST
...
__all__ = ["Trading212Adapter"]


class Trading212Adapter:
    """Roadmap marker for Trading212 broker support. Not implemented."""

    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "Trading212Adapter is a roadmap marker. Use "

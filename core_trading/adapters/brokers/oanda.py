...
#     async def _start_price_streaming(self):
#         "Start price streaming"
#         try:
...
#     async def _stop_price_streaming(self):
#         "Stop price streaming"
#         try:
#             self._stream_active = False
...
#     def get_supported_order_types(self):

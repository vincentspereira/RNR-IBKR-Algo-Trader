...
# def calculate_hammer_confidence(candle: CandleData):
...
# def calculate_shooting_star_confidence(candle: CandleData):
...
# def calculate_doji_confidence(candle: CandleData):
...
# def calculate_marubozu_confidence(candle: CandleData):
#     "Calculate confidence for marubozu pattern"
#     body_ratio = candle.body_size / candle.total_range
#     return min(0.5 + body_ratio * 0.5, 1.0)


# def calculate_engulfing_confidence(prev: CandleData, curr: CandleData):
...
# def calculate_tweezer_confidence(prev: CandleData, curr: CandleData):
...
# def calculate_piercing_confidence(prev: CandleData, curr: CandleData):
...
# def calculate_dark_cloud_confidence(prev: CandleData, curr: CandleData):

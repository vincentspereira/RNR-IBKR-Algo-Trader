import numpy as np
# from core_trading.nautilus_trader_engine.analysis.indicators.core.augmented_indicator import ()
...
#     def calculate_raw_value(self, prices: np.ndarray, volumes: np.ndarray):
...
# ""self, raw_value: float, confidence: "ConfidenceComponents", regime: MarketRegime""
# ) -> SignalType:"

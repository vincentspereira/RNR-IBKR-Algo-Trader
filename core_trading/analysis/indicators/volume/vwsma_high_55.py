...
# Volume Weighted Simple Moving Average of High (55 Period)

# A basic volume-weighted SMA using the high price over 55 periods."
...
class VWSMAHigh55Config:""
#     "Configuration for VWSMAHigh55 instances."
...
class VWSMAHigh55(Indicator):""
#     "Volume Weighted SMA of High (55 periods)."

#     def __init__(self, config: VWSMAHigh55Config = None) -> None:
#         "config = config or VWSMAHigh55Config()"
#         super().__init__()
...
#     @property
#     def name(self):
#         return "vwsma_high_55"

#     def handle_bar(self, bar: Bar):
#         "Update with bar, using high price."
#         self.update_raw(
#             bar.high.as_double(),
...
# ) -> None:"
#         "Update with raw high price and volume."
#         self.price = price

...
#     def spread_sma(self, spread: np.ndarray, period: int = 20):
#         "Simple Moving Average of spread."
#         return talib.SMA(spread, timeperiod=period)

#     def spread_ema(self, spread: np.ndarray, period: int = 20):
#         "Exponential Moving Average of spread."
#         return talib.EMA(spread, timeperiod=period)

#     def spread_rsi(self, spread: np.ndarray, period: int = 14):
...
#     def ratio_momentum(self, ratio: np.ndarray, period: int = 10):
...
#     def spread_z_score(self, spread: np.ndarray, period: int = 252):
...
#     def half_life_indicator(self, spread: np.ndarray, period: int = 252):

...
#     @abstractmethod
#     def generate_signals(self, data: pd.DataFrame, **kwargs):
...
# def get_backtesting_manager(name: str, config: BacktestConfig):
